...
uniform vec2 g_Bounds; // {"default":"0 1","label":"ui_editor_properties_bounds","material":"bounds"}
...
uniform vec2 g_AudioBounds; // {"default":"0.0 1.2","label":"ui_editor_properties_audio_bounds","material":"audiobounds"}
