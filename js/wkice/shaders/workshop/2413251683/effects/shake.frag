...
uniform sampler2D g_Texture1; // {"default":"util/noflow","label":"ui_editor_properties_shake_direction_map","material":"flow","mode":"flowmask"}
uniform sampler2D g_Texture2; // {"default":"util/white","label":"ui_editor_properties_time_offset","material":"phase","mode":"opacitymask"}
uniform sampler2D g_Texture3; // {"combo":"MASK","default":"util/white","label":"ui_editor_properties_opacity","material":"mask","mode":"opacitymask"}
